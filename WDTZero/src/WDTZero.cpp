...
// ///// This should allow the WDT to simply connect to GCLK2, which has aleady been configured by the 
// //   RTCZero library for the external crystal XOSC32K clock source.
